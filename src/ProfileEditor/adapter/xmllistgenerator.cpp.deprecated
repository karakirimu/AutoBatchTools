...
void XmlListGenerator::getListStructure(QList<QStringList> *ctos, QHash<int, int> *posinfo)
{
...
QStringList XmlListGenerator::createCmdElement(QString value, int index)
{
