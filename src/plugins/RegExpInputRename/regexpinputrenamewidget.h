...
class RegExpInputRenameWidget : public PluginWidget
{
    Q_OBJECT

public:
    explicit RegExpInputRenameWidget(QWidget *parent = nullptr);
    ~RegExpInputRenameWidget() override;
...
private slots:
    ...
    void on_separatorLineEdit_textChanged(const QString &arg1);
...
private:
    ...
    QHash<RegExpInputRenameList, QString> settingargs;
};
